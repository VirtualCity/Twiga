...
class Tas_m extends CI_Model{
   ...
   /* function assign_tas_to_town($ta_id,$town_id,$region_id){
    ...
    /*Retrieve a tas with specified id*/
    function get_tas($id){
        $this->db->select('*');
    ...
    /*Check tas mobile doesnt exists*/
    ...
    /*Verify tas name doesnt exists apart from current tas being edited*/
    ...
    /*Verify tas mobile doesnt exists apart from current tas being edited*/
    ...
    /*Verify tas email doesnt exists apart from current tas being edited*/
