...
<div id="content" class="no-sidebar"> <!-- Content start -->
    <div class="top_bar">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="<?=base_url("farmers")?>">Farmers</a><span class="divider">/</span></li>
        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                <div class="well green">
                    <div class="well-content no_search">
                        <table class="table table-striped table-hover">
                            <thead><h4>Farmer Details</h4></thead>
                            <tbody>
                            <tr><td><strong>Name:</strong></td><td><a class="txt_blue"><?= $name;?></a></td></tr>
                            <tr><td><strong>Mobile Number:</strong></td><td><a class="txt_blue"><?= $mobile;?></a></td></tr>
                            </tbody>
                        </table>
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('farmers/sendsms')?>" method="post" class="form-horizontal">
                        <input type="hidden" name="id" value="<?=$id?>"/>
                        <input type="hidden" name="name" value="<?=$name?>"/>
                        <div class="form_row">
                            <label for="mobile" class="field_name align_right lblBold">Mobile</label>
                            <div class="field">
                                <input class="span3" type="text" name="mobile" id="mobile" readonly="readonly" value="<?=$mobile?>"/> <font color="red"> *</font>
