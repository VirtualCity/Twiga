...
<div id="content" class="no-sidebar"> <!-- Content start -->
    <div class="top_bar">
        <ul class="breadcrumb">
            ...
            <li class="active"><a>Edit Farmer</a></li>
        </ul>
    </div>
        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('farmers/modify')?>" method="post" class="form-horizontal">
                        <input type="hidden" name="id" value="<?=$id?>"/>
                        <div class="form_row">
                            <label for="name" class="field_name align_right lblBold">Farmer Name </label>
                            <div class="field">
                        ...
                        <div class="form_row">
                            ...
                            <div class="field">
                                <button type="submit" class="btn btn-large dark_green"><i class="icon-edit"></i> Edit Farmer</button>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        if (region_id != ""){
            var post_url = "<?=base_url()?>farmers/get_towns/" + region_id;
            jQuery.ajax({
                type: "POST",
                url: post_url,
