...
<div id="content" class="no-sidebar"> <!-- Content start -->
    <div class="top_bar">
        <ul class="breadcrumb">
            ...
            <li class="active"><a>Import Technical Assistant's</a></li>
        </ul>
    </div>
        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                <div class="well-header">
                    <h5>Import Technical Assistant's</h5>
                </div>
                <div class="well-content no_search">
                    <?php //echo $status->message; ?>
                    <form action="<?=base_url('tas/do_upload')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
