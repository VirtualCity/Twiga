...
<div id="content" class="no-sidebar"> <!-- Content start -->
    <div class="top_bar">
        <ul class="breadcrumb">
            ...
            <li><a href="<?=base_url("messages/received")?>">Received Messages</a><span class="divider">/</span></li>
        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('messages/received/send')?>" method="post" class="form-horizontal">
                        ...
                        <div class="form_row">
                            <label for="from" class="field_name align_right lblBold">Business Name</label>
                            <div class="field">
                                <input type="text" name="from" id="from" placeholder="Stockist Business Name" class="span6" value="<?=$stockist?>" readonly="true"/>
                            </div>
                        </div>
                        <div class="form_row">
