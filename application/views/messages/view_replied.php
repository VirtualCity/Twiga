...
<script type="text/javascript">
    jQuery(document).ready(function(){
        jQuery('#example').dataTable({
            "processing": true,
            "bServerSide": true,
            "sAjaxSource": "<?=base_url('messages/replied/datatable')?>",
            "bJQueryUI": true,
            ...
            aoColumns: [
                ...
                { "mData": "sent_to","bSearchable": true,"bSortable": true },
                { "mData": "biz_name","bSearchable": true,"bSortable": true },
                { "mData": "name","bSearchable": true,"bSortable": true },
                { "mData": "reply","bSearchable": true,"bSortable": true },
                { "mData": "message","bSearchable": true,"bSortable": true },
                { "mData": "sent_by","bSearchable": true,"bSortable": true},
