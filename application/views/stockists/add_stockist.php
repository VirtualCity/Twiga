...
<div id="content" class="no-sidebar"> <!-- Content start -->
    <div class="top_bar">
        <ul class="breadcrumb">
            ...
            <li><a href="<?=base_url("stockists")?>">Stockists</a><span class="divider">/</span></li>
            <li class="active"><a>Add Stockist</a></li>
        </ul>
    </div>
        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('stockists/add')?>" method="post" class="form-horizontal">
                        ...
                        <div class="form_row">
                            ...
                            <div class="field">
                                <button type="submit" class="btn btn-large dark_green"><i class="icon-plus"></i> Add Stockist</button>
                            </div>
                        </div>
