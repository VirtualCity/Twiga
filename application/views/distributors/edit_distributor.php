...
<div id="content" class="no-sidebar"> <!-- Content start -->
    <div class="top_bar">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="<?=base_url("distributors")?>">Distributors</a><span class="divider">/</span></li>
            <li class="active"><a>Edit Distributor</a></li>
        </ul>
    </div>
        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('distributors/modify')?>" method="post" class="form-horizontal">
                        ...
                        <hr class="field-separator">
                        <div class="form_row">
                            <label for="mobile" class="field_name align_right lblBold">Mobile #1 </label>
                            <div class="field">
                        ...
                        <hr class="field-separator">
                        <div class="form_row">
                            <label for="status" class="field_name align_right lblBold">Status</label>
                            <div class="field">
                        ...
                        <div class="form_row">
                            ...
                            <div class="field">
                                <button type="submit" class="btn btn-large dark_green"><i class="icon-edit"></i> Edit Distributor</button>
                            </div>
                        </div>
