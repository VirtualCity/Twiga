            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('groups/modify')?>" method="post" class="form-horizontal">
                        ...
                        <div class="form_row">
                            <label for="group" class="field_name align_right lblBold">Group Name </label>
                            <div class="field">
                        ...
                        <div class="form_row">
                            ...
                            <div class="field">
                                <button type="submit" class="btn btn-large blue"><i class="icon-plus"></i> Edit Group</button>
                            </div>
                        </div>
