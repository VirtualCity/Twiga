        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                <div class="well-header">
                    <h5>Email Weekly Report to TA's</h5>
                </div>
                <div class="well-content no_search">
                    <?php //echo $status->message; ?>
                    <form action="<?=base_url('reports/tas/mail')?>" method="post"  class="form-horizontal">

                        <div class="form_row">
                            <div class="well">
                                <div class="well-content no_search">
                                <span class="lblBold">Click on the button below to email Technical Assistants a weekly stockists purchase report.</span>
                                </div>
                            </div>
