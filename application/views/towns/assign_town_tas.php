        ...
        <div class="widgets_area">
            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('towns/assigntas')?>" method="post" class="form-horizontal">
                        ...
                        <hr class="field-separator">
                        <div class="form_row">
                            <label for="tas" class="field_name align_right lblBold">Technical Assistants </label>
                            <div >
                                <select class="field" id="myduallistbox" multiple="multiple" name="tas[]" size="15">
                                    <?php
                                    if(!empty($area_tas)){
                                        foreach($area_tas as $row) { ?>
