            ...
            <div class="well blue">
                ...
                <div class="well-content no_search">
                    ...
                    <form action="<?=base_url('managers/add')?>" method="post" class="form-horizontal">
                        ...
                        <div class="form_row">
                            <label for="name" class="field_name align_right lblBold">Manager Name </label>
                            <div class="field">
                        ...
                        <div class="form_row">
                            ...
                            <div class="field">
                                <button type="submit" class="btn btn-large dark_green"><i class="icon-plus"></i> Add Manager</button>
                            </div>
                        </div>
