...
class Mail_report extends Admin_Controller
{
    ...
    function index(){
        /*   1. Retrieve all towns
             2. loop through towns store region_id and town_id
             3. retrieve purchase reports for that town
             4. create excel and save it
             5. send Email
        */
                ...
                if($query){
                    ...
                    if($emailTo){
                        ...
                        if($file_created){
                            ...
                            $this->email->attach('./exports/tas/Stockist_purchase_report.xls');
    ...
    function createExcel($query,$town_name,$region_name){
        ...
        try{
            ...
            $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
            $objWriter->save('./exports/tas/'.$filename);
