...
class Tas extends Admin_Controller
{
                    ...
                    if($emailTo){
                        ...
                        if($file_created){
                           // echo 'success';
                            ...
                            $this->email->attach('./exports/tas/'.$town_name.'/Stockist_purchase_report.xls');
    ...
    function createExcel($query,$town_name,$region_name){
        ...
        try{
            ...
            $objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel5');
            $objWriter->save('./exports/tas/'.$town_name.'/'.$filename);
